...
const MessageType MessageType_MIN = TYPE_ERROR;
const MessageType MessageType_MAX = TYPE_RESPONSE;
...
const ErrorCode ErrorCode_MIN = EC_INVALIDPROTO;
const ErrorCode ErrorCode_MAX = EC_INVALIDRESPONSE;
...
class CallMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:minirpc.CallMessage) */ {
 public:
  CallMessage();
  virtual ~CallMessage();
  ...
  // @@protoc_insertion_point(class_scope:minirpc.CallMessage)
 private:
...
// string method = 1;
inline void CallMessage::clear_method() {
  method_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& CallMessage::method() const {
  // @@protoc_insertion_point(field_get:minirpc.CallMessage.method)
  return method_.GetNoArena();
}
inline void CallMessage::set_method(const ::std::string& value) {
  
  method_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:minirpc.CallMessage.method)
}
#if LANG_CXX11
inline void CallMessage::set_method(::std::string&& value) {
...
#endif
inline void CallMessage::set_method(const char* value) {
  
  method_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:minirpc.CallMessage.method)
}
inline void CallMessage::set_method(const char* value, size_t size) {
  
  method_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:minirpc.CallMessage.method)
}
inline ::std::string* CallMessage::mutable_method() {
  
  // @@protoc_insertion_point(field_mutable:minirpc.CallMessage.method)
  return method_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CallMessage::release_method() {
  // @@protoc_insertion_point(field_release:minirpc.CallMessage.method)
  
  return method_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void CallMessage::set_allocated_method(::std::string* method) {
  if (method != NULL) {
...
#if LANG_CXX11
inline void CallMessage::set_arguments(::std::string&& value) {
...
#endif
inline void CallMessage::set_arguments(const char* value) {
...
inline void CallMessage::set_arguments(const char* value, size_t size) {
...
inline ::std::string* CallMessage::mutable_arguments() {
...
inline ::std::string* CallMessage::release_arguments() {
...
inline void CallMessage::set_allocated_arguments(::std::string* arguments) {
  if (arguments != NULL) {
