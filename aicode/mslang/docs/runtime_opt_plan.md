...
|---------|-------|----------|--------|------|--------|
| OPT-P0-01 | Remove Object vtable (incl. virtual dtor) | P0 | Large | — | `[ ]` |
...
### `[ ]` OPT-P0-01: Remove Object vtable (incl. virtual dtor)
...
### `[ ]` OPT-P0-03: ObjUpvalue/ObjBoundMethod slab pool allocator
...
### `[ ]` OPT-P1-02: NativeFn as raw function pointer
...
### `[ ]` OPT-P1-03: Constant pool deduplication
