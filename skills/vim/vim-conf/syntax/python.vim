...
syn match pythonFunctionName "\<[a-zA-Z_][a-zA-Z_0-9]*\>[^()]*)("me=e-2
syn match pythonFunctionName "\<[a-zA-Z_][a-zA-Z_0-9]*\>\s*("me=e-1
hi pythonFunctionName gui=none guifg=palegreen
